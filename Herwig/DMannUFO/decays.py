...
Decay_Y0 = Decay(name = 'Decay_Y0',
                 particle = P.Y0,
                 partial_widths = {(P.b,P.b__tilde__):'(3*gSd33**2*MY0**4)/(16.*cmath.pi*abs(MY0)**3)',
                                   (P.c,P.c__tilde__):'(3*gSu22**2*MY0**4)/(16.*cmath.pi*abs(MY0)**3)',
                                   (P.d,P.d__tilde__):'(3*gSd11**2*MY0**4)/(16.*cmath.pi*abs(MY0)**3)',
                                   (P.s,P.s__tilde__):'(3*gSd22**2*MY0**4)/(16.*cmath.pi*abs(MY0)**3)',
                                   (P.t,P.t__tilde__):'((-12*gSu33**2*MT**2 + 3*gSu33**2*MY0**2)*cmath.sqrt(-4*MT**2*MY0**2 + MY0**4))/(16.*cmath.pi*abs(MY0)**3)',
                                   (P.u,P.u__tilde__):'(3*gSu11**2*MY0**4)/(16.*cmath.pi*abs(MY0)**3)'})
