...
VVS1 = Lorentz(name = 'VVS1',
               spins = [ 3, 3, 1 ],
               structure = '-8*Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,1) + 8*Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,2)')
...
VVVS2 = Lorentz(name = 'VVVS2',
                spins = [ 3, 3, 3, 1 ],
                structure = '-8*Epsilon(1,2,3,-1)*P(-1,1) - 8*Epsilon(1,2,3,-1)*P(-1,2) - 8*Epsilon(1,2,3,-1)*P(-1,3)')
