...
V_122 = Vertex(name = 'V_122',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV14, L.FFV15 ],
               couplings = {(0,0):C.GC_13,(0,1):C.GC_31})

V_123 = Vertex(name = 'V_123',
               particles = [ P.c__tilde__, P.c, P.Y1 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV14, L.FFV15 ],
               couplings = {(0,0):C.GC_14,(0,1):C.GC_32})

V_124 = Vertex(name = 'V_124',
               particles = [ P.d__tilde__, P.d, P.Y1 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV14, L.FFV15 ],
               couplings = {(0,0):C.GC_15,(0,1):C.GC_33})

V_125 = Vertex(name = 'V_125',
               particles = [ P.e__plus__, P.e__minus__, P.Y1 ],
               color = [ '1' ],
               lorentz = [ L.FFV14, L.FFV15 ],
               couplings = {(0,0):C.GC_16,(0,1):C.GC_34})

V_126 = Vertex(name = 'V_126',
               particles = [ P.mu__plus__, P.mu__minus__, P.Y1 ],
               color = [ '1' ],
               lorentz = [ L.FFV14, L.FFV15 ],
               couplings = {(0,0):C.GC_17,(0,1):C.GC_35})
...
V_129 = Vertex(name = 'V_129',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV14, L.FFV15 ],
               couplings = {(0,0):C.GC_19,(0,1):C.GC_37})

V_130 = Vertex(name = 'V_130',
               particles = [ P.u__tilde__, P.u, P.Y1 ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV14, L.FFV15 ],
               couplings = {(0,0):C.GC_21,(0,1):C.GC_39})
...
V_170 = Vertex(name = 'V_170',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV14, L.FFV18 ],
               couplings = {(0,0):C.GC_96,(0,1):C.GC_103})
...
V_173 = Vertex(name = 'V_173',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV14, L.FFV16 ],
               couplings = {(0,0):C.GC_95,(0,1):C.GC_103})
...
V_179 = Vertex(name = 'V_179',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV14, L.FFV17 ],
               couplings = {(0,0):C.GC_95,(0,1):C.GC_104})
